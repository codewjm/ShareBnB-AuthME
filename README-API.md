...
* Request
  * Method: GET
  * URL: /api/spots/current-user-spots
...
* Request
  * Method: GET
  * URL: /api/reviews/current-user-reviews
  * Body: none
...
* !!Question: Why would my URL be /reviews/:id or /reviews/:userId ?
* Require Authentication: true
...
* Request
  * Method: GET
  * URL: /api/bookings/current-user-bookings
  * Body: none
